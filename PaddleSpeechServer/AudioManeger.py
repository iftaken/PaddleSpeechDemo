...
class AudioMannger:
    def __init__(self, robot, frame_length=160, frame=10, data_width=2):
        # 二进制 pcm 流 
        self.audios = b''
        self.asr_result = ""
        # Speech 核心主体
            ...
            if self.is_speech(start_index=start, pcm_bins=pcm_bin):
                ...
                if self.on_asr:
                    ...
                    if self.silence_cnt > self.max_silence_cnt:
                        ...
                        file_path = os.path.join(self.file_dir, f"asr_{random.randint(0, 100)}.wav")
